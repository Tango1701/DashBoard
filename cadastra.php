...
<body>
    ...
    <div id="registration-form">
        <div class='fieldset'>
            <legend>Criar uma conta de Usuario!</legend>
            <form action="supervisor/create.php" method="post">
                <div class='row'>
                    <label for='firstname'>Nome completo</label>
                    <input type="text" placeholder="Nome completo" name='name' id='firstname' data-required="true" data-error-message="Your First Name is required">
                </div>
                <div class='row'>
                    <label for="email">User Name</label>
                    <input type="text" placeholder="Nome de usuario" name='user' data-required="true">
                </div>
                <div class='row'>
                    <label for="email_again">Senha</label>
                    <input type="text" placeholder="Digite a sua senha" name='password' data-required="true">
                </div>
                <div class='row'>
